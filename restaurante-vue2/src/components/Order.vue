        ...
        return{
            formData: {
                name: {
                    ...
                    valid: true,
                    isValid: () => {
                        this.formData.name.valid = this.formData.name.valid.length;
                    }
                },
                cellphone: {
                    value: '',
                    ...
                    valid: true,
                    isValid: () => {
                        this.formData.cellphone.valid = (this.formData.cellphone.valid.length == 16);
                    }
                },
                cep: {
                value: '',
                ...
                valid: true,
                isValid: () => {
                    this.formData.cep.valid = (this.formData.cep.valid.length);
                    }                    
                },
                city: {
                value: '',
                ...
                valid: true,
                isValid: () => {
                    this.formData.city.valid = (this.formData.city.valid.length);
                    }                    
                },
                street: {
                value: '',
                ...
                valid: true,
                isValid: () => {
                    this.formData.street.valid = (this.formData.street.valid.length);
                    }                    
                },
                number: {
                value: '',
                placeholder:'Digite o número',
                errorMessage: 'O numero é obrigatória',
                label: 'Numero*',
                valid: true,
                isValid: () => {
                    this.formData.number.valid = (this.formData.number.valid.length);
                    }                    
                }
        },
